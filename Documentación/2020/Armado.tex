...
\begin{sidewaysfigure}[htb]
	\centering\includegraphics[trim =3cm 1.9cm 0.80cm 0.5cm, width=0.8\paperheight]{EsquematicoEntrenador};
...
\end{sidewaysfigure}%
\begin{sidewaysfigure}[htb]
	\centering\includegraphics[trim =1cm 1.85cm 0.5cm 0cm, width=0.8\paperheight,clip=true]{PistasEntrenador}	\caption{Vista inferior detalle de las pistas del entrenador digital}\label{PistaEntrenador}
\end{sidewaysfigure}%	
\begin{table}[htb]
...
\begin{sidewaysfigure}[htb]
	...
	\centering\includegraphics[trim =0cm 0cm 0cm 0cm, width=0.8\paperheight,clip=true]{PosterCompletoEntrenador.png}
